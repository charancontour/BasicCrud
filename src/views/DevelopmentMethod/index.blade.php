@extends('base')
@section('title')
  Development Methods - Index
@stop
@section('content')
<div class="content-header">
  <div class="title">
    <h1>List Of Development Methods</h1>
  </div>
  <a href="{{url('timefortalent/development-method/create')}}">
    <button type="button" class="primary">Create</button>
  </a>
</div>
@if(count($development_methods) > 0)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="actions no-sort">
        @if(Auth::user()->hasUrlAccess('timefortalent/development-method/view/*'))
        <a href="/timefortalent/development-method/view/{{$development_method->id}}">
        ...
        @if(Auth::user()->hasUrlAccess('timefortalent/development-method/edit/*'))
        <a href="/timefortalent/development-method/edit/{{$development_method->id}}">
        ...
        @if(Auth::user()->hasUrlAccess('timefortalent/development-method/delete/*'))
        <a href="/timefortalent/development-method/delete/{{$development_method->id}}">
